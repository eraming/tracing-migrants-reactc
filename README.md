...
This project was an exercise in building a simple data visualization using ReactJS. The bar graph represents totals by region, which can be further filtered by month of the year. It draws data from json files and is broken down into simple components. 
